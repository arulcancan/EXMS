            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-subhead-line"> Enter the amount and submit object code wise to Add or Deduct <br><br>
                          <ul>
             </div>
                </div>
                <!-- /. ROW  -->
...
<h4> Location <b><u><?php echo $res['DISTRICT']  ?></u></b></h4><br>
            ...
            <table class="table table-striped table-bordered table-hover" style="width: 100%">
                                    <thead>
                                        ...
                                        <th><u> <center>Cut Off</center> </u></th>
