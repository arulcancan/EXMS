...
<body>
       ...
       $sqll=mysqli_query($db,$queryy);
                     ...
                     <li>
                        <a href=""><i class="fa fa-dollar "></i>Allocation <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="balance_report.php"><i class="fa fa-flash "></i>View Balance Reports</a>
                            </li>
                             <li>
        ...
        <div id="page-wrapper">
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Edit Memo Board </h1>
                        <h1 class="page-subhead-line"> Update memos by select sticky note   </h1>
    ...
    <li class="lii">
        <?php $idd = $rekod['ID']; 
        $update ="memo-update.php?id=$idd"; ?>
      <a href="<?php echo $update?>"><center>
        <p><?php echo $rekod['ID']; ?></p></center>
