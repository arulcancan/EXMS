                    ...
                    <li>
                        <a href="" class="active-menu-top" ><i class="fa fa-desktop "></i>Expenses Reporting <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in" >
                            <li>
                                <a href="monthly_report.php" class="active-menu"><i class="fa fa-calculator"></i>Monthly Report</a>
                            </li>
                            <li>
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-subhead-line">Generate Expenditure report by select District /all district/Year/Month  </h1>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <center>
                    <form class="" method="post" action="monthly_report.php" >
...
+OC_20_1_1_1409_2_J11) as sumOC_20_1_1_1409_2,
  ...
  SUM(OC_20_1_1_2401) as 'sumOC_20_1_1_2401', REVISED FROM schedule02 WHERE U_DATE LIKE '%$month%' AND U_DATE LIKE '%$year%' ";
                    $sql=mysqli_query($db,$query);
                    $res=mysqli_fetch_array($sql);
                        
                    }
                    else if($district == "All Districts Only") {
                        $query = "SELECT USER_NAME, DISTRICT,
  U_DATE, SUM(OC_20_1_1_1001+OC_20_1_1_1002+
OC_20_1_1_1003_1+
OC_20_1_1_1003_2+
...
+OC_20_1_1_1409_2_J11) as sumOC_20_1_1_1409_2,
  ...
  SUM(OC_20_1_1_2102) as 'sumOC_20_1_1_2102',
  SUM(OC_20_1_1_2103) as 'sumOC_20_1_1_2103',
  SUM(OC_20_1_1_2401) as 'sumOC_20_1_1_2401', REVISED FROM schedule02 WHERE DISTRICT != 'Head Office' AND U_DATE LIKE '%$month%' AND U_DATE LIKE '%$year%' ";
                    $sql=mysqli_query($db,$query);
                    $res=mysqli_fetch_array($sql);
...
+OC_20_1_1_1409_2_J11) as sumOC_20_1_1_1409_2,
  ...
  SUM(OC_20_1_1_2102) as 'sumOC_20_1_1_2102',
  SUM(OC_20_1_1_2103) as 'sumOC_20_1_1_2103',
  SUM(OC_20_1_1_2401) as 'sumOC_20_1_1_2401', REVISED FROM schedule02 WHERE DISTRICT = '$district' AND U_DATE LIKE '%$month%' AND U_DATE LIKE '%$year%' ";
                    $sql=mysqli_query($db,$query);
                    $res=mysqli_fetch_array($sql);
                }
                    ?>
                    ...
                    <div class="panel panel-default" id="example" >
                        ...
                        <div class="panel-heading">
                         ...
                         <div class="col-md-3" style="color: blue;"><?php echo $res['REVISED']; ?> </div>
