       ...
       $sqll=mysqli_query($db,$queryy);
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    ...
                    <form class="contact100-form " autocomplete="off" method="GET" action="save-revise.php">

                        <?php

                         $id=$_GET['id'];

                        $query = "SELECT * FROM schedule02 WHERE ID = $id";
        ...
        <div class="wrap-input100 validate-input bg1" >
                ...
                <div class="container-contact100-form-btn">
                 <button name="submit" type="submit" id="register" class="contact100-form-btn"/>Revise Form </button>
                </div>
            </form>
