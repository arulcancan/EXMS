...
OC_20_1_1_2102+
OC_20_1_1_2103+
OC_20_1_1_2401) AS 'total' FROM assign_allocation WHERE DISTRICT = '$district' AND U_DATE LIKE '%$year%'";
...
OC_20_1_1_2102+
OC_20_1_1_2103+
OC_20_1_1_2401) AS 'total' FROM schedule02 WHERE DISTRICT = '$district' AND U_DATE LIKE '%$year%' ";
...
var chart = new CanvasJS.Chart("chartContainer", {
    ...
    data: [{
        type: "pie",
        showInLegend: true,
        toolTipContent: "{name}: Rs.  <strong>{y}/-</strong>",
        indexLabel: "{name} - Rs. {y}/-",
        dataPoints: [
            { y: <?php echo $rea; ?>, name: "Remaining Provision"  },
            { y: <?php echo $exp; ?>, name: "Expenditure" },
       ...
       <?php include 'navbar.php'; 
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line"> Expenditure Management System </h1>
                        <h1 class="page-subhead-line">Overall up-to-date view of Net Provision expenditure and Remaining Provision  </h1>
