       ...
       $sqll=mysqli_query($db,$queryy);
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Delete Conformation</h1>
                ...
                <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        $query = "DELETE FROM schedule02_temp WHERE ID = $id";


                    $sql=mysqli_query($db,$query);
                    

                     echo "Record for Schidule ID $id has been deleted... <a href='approval.php' class='alert-link'>Back</a>"
                     ?>
                            </div>
